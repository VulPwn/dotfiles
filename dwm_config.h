...
static const char col_gray2[]       = "#4a7d7d";
static const char col_gray3[]       = "#c4c8fc";
static const char col_gray4[]       = "#ecfeab";
static const char col_cyan[]        = "#0063a4";
...
static const char *backup_termcmd[]  = { "xterm", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_t, 	   spawn,          {.v = backup_termcmd } },
	{ MODKEY|ShiftMask,		XK_w,      spawn,          {.v = web_browser } },
	{ MODKEY|ShiftMask,             XK_f,      spawn,          {.v = file_explorer } },
